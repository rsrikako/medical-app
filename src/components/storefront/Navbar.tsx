        ...
        <div className="flex items-center justify-between min-h-16 py-3 sm:py-0">
          ...
          <div className="flex items-center min-w-0">
            ...
            <button
              ...
              className="md:hidden mr-3 p-2 rounded-xl text-slate-700 hover:bg-slate-100 border border-slate-200/80 transition-colors shrink-0"
          ...
          <div className="flex items-center ml-3 shrink-0">
            <Link
              ...
              aria-label={`Cart with ${totalLineItems} line item${
                totalLineItems === 1 ? '' : 's'
              }`}
            >
              <ShoppingBag className="w-4 h-4 text-emerald-400" />

              <span className="hidden sm:ml-2 sm:inline font-bold sm:text-xs uppercase tracking-wider">
                Order Cart
              </span>
