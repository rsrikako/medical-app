...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const login = async (email: string, pass: string) => {
    ...
    try {
      ...
      // Fallback for demo login if firebase auth fails (e.g., admin@srisubrahmanyaagencies.com / Subpharma@2025)
      if (email.toLowerCase() === 'admin@srisubrahmanyaagencies.com' && pass === 'Subpharma@2025') {
        setIsDemoAdmin(true)
